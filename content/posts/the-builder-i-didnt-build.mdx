...
---
**Takeaway:** The previous three versions of this product all assumed a template-authoring UI was the hard thing to build. The 2026 version doesn't have one. An AI reads a sample document and produces a template directly. This post explains how that works and why it changed the shape of the product.
